...
*8 strategies over 184 scored tasks · kNN \$13.21 at 78.3% vs baseline \$96.02 at 95.1% (14% of the bill, cache-aware) · cost is the wide axis: kNN's naive total spans \$9.15–\$17.76 (95% bootstrap) · area under the live frontier 0.853*
> **Caveat.** scored on 184 coverage-selected tasks (dropped are harder); 5 of 8 are not selectable as router.strategy.
...
Session-Cascade: \$28.71 cache-aware / \$33.56 naive, 96.74% (n=184, blocked as a NAME only — the mechanism ships as escalation.enabled)
Always-Frontier: \$96.02 cache-aware / \$96.02 naive, 95.11% (n=184, live, on the frontier)
...
frontier vs strategy_summary.csv Pareto: drawn-only Always-Frontier (both on cache-aware cost; a difference here is the live-only filter)
...
*4 of 8 strategies reach 96.74% ± 1pp · no live strategy reaches this band — none of the headroom is buyable today*
> **Caveat.** no live strategy reaches this band — none of the headroom is buyable today
...
Session-Cascade: \$33.56, 96.74% (blocked)
