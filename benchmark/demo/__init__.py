...
# keys its bijection on the half, so giving the demo family its own directory, its own
# `figures.json` and its own docs page is what makes "never mixed with a measurement figure" a
# gate rather than a convention. The canvases carry `SYNTHETIC — NOT MEASURED` on their face.
