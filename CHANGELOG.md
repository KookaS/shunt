...
- **The live pool drops the models measurement shows to be strictly dominated.** `router.yaml`'s
  ...
  `glm-5.2`, `kimi-k3`, plus the frontier escalation tail. `qwen3.7-plus`, `gpt-5-mini` and
  ...
  `glm-5.2` instead of the flat-to-harmful rungs; a residual skip of `kimi-k3` (price-slotted
